...
export default function Nav() {
    ...
    const activeLink = `${inactiveLink} bg-white text-red-600 rounded-lg`; 
    ...
    return (
       <aside className=" p-4 pr-0">
        ...
        <nav className="flex flex-col gap-2">
                    ...
                    <Link href={'/orders'} className={pathname.includes('./products') ? activeLink : inactiveLink} >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    ...
                    <Link href={'/settings'} className={pathname.includes('./products') ? activeLink : inactiveLink} >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
